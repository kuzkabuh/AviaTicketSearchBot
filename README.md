...
- После выдачи результатов можно запросить календарные цены на даты `±3 дня` от выбранной даты вылета.
...
11. После выдачи результатов бот спрашивает, нужно ли посмотреть цены рядом с выбранной датой, и по кнопке `📅 ±3 дня` показывает доступные календарные цены с отметками выбранной даты и самой низкой найденной цены.
