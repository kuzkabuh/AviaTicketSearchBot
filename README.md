...
- При создании подписки пользователь выбирает режим уведомлений: при любом изменении, только при снижении или ниже заданной суммы.
...
12. При нажатии `🔔 Отслеживать цену` бот спрашивает режим уведомлений: `🔄 При любом изменении`, `📉 Только при снижении`, `🎯 Ниже заданной суммы`. На этом подэтапе первые два режима создают подписку сразу, а режим с заданной суммой переводит пользователя к вводу суммы для следующего подэтапа.
